...
<body>
    ...
    <div class="container">
        ...
        ?>
        <div class="row">
            <div class="jumbotron p-3 mb-3 text-warning" style="display: flex;justify-content: center;width: 28%; border: 2px solid ;border-radius: 50px;margin: 0 auto; background-color: #000; ">
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                        ...
                        <button type="submit" name="updateProfilePic" class="btn custom-btn btn-3" style="margin-top: -20px;font-size: 15px;padding: 3px 8px;">Update</button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="partials/_logout.php"><button class="btn btn-danger" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3  text-dark" style="display: flex;justify-content: center;">
                <div class=" p-3 bg-warning" style="border-radius: 1.1rem;background-color: aliceblue;">
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group  col-md-6">
                                ...
                                <input class="form-control" id="password" name="password" placeholder="Enter Password" type="password" required minlength="4" maxlength="15" data-toggle="password">
                            </div>
                        </div>
                        <button type="submit" name="updateProfileDetail" class="btn custom-btn btn-3" style="margin-left: 220px; margin-right: 20px ;">Update</button>
                    </form>
                </div>
            </div>
        </div>
