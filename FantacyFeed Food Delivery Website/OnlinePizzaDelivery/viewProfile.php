...
<body>
    ...
    ?>
        ...
        <div class="container">
            ...
            ?>
            <div class="row">
                <div class="jumbotron p-3 mb-3 text-dark" style="display: flex;justify-content: center;width: 30%;border-radius: 50px;margin: 0 auto;">
                    <div class="user-info">
                        ...
                        <form action="partials/_manageProfile.php" method="POST">
                            <small>Remove Image: </small><button type="submit" class="btn custom-btn btn-4" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;">remove</button>
                        </form>
                        ...
                        <ul class="meta list list-unstyled" style="text-align:center;">
                            ...
                            <li class="my-2"><a href="partials/_logout.php"><button class="btn custom-btn btn-4" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                        </ul>
                    </div>
                </div>
                <div class="content-panel mb-4 text-dark" style="display: flex;justify-content: center;">
                    <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                        ...
                        <form action="partials/_manageProfile.php" method="post">
                            ...
                            <button type="submit" name="updateProfileDetail" class="btn custom-btnn btn-1" style="margin:20px; margin-left: 200px;">Update</button>
                        </form>
                    </div>
                </div>
            </div>
