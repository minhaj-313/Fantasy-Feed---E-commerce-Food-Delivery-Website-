        ...
        <div class="col-lg-12">
          <div class="card card-shadow border-0 mb-4">
            <div class="row">
                ...
                <div class="contact-box p-4">
                  ...
                  <form action="partials/_manageContactUs.php" method="POST">
                    <div class="row">
                      ...
                      <?php if ($loggedin) { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn custom-btn btn-3 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                          <button type="button" class="btn custom-btn btn-3 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> HISTORY <i class="ti-arrow-right"></i></span></button>
                        </div>
                      <?php } else { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn custom-btn btn-3 py-2 px-3" disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
              ...
              echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.png)">
                          <div class="detail-box p-4">
                            <h5 class="text-dark font-weight-light mb-3">ADDRESS</h5>
                            <p class="text-dark op-7">' . $address . '</p>
                            <h5 class="text-dark font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-dark op-7">' . $contact1 . '
                              <br> ' . $contact2 . '</p>
                            <div class="round-social dark">
                              <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=' . $email . '" class="ml-0 text-decoration-none text-dark border border-dark rounded-circle" target="_blank"><i class="far fa-envelope"></i></a>
                              <a href="https://github.com/minhaj-313" class="text-decoration-none text-dark border border-dark rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
                              <a href="https://youtube.com/" class="text-decoration-none text-dark border border-dark rounded-circle" target="_blank"><i class="fab fa-youtube"></i></a>
                            </div>
                          </div>
                        </div>';
              ?>
