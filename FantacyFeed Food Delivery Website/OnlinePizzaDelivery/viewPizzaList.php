            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($loggedin) {
                    ...
                    if ($quaExistRows == 0) {
                        ...
                        echo '<a href="viewCart.php"><button class="btn custom-btn btn-2" style="margin:5px;">Go to Cart</button></a>';
                    }
                } else {
                    echo '<button class="btn custom-btn btn-1" data-toggle="modal" data-target="#loginModal" style="margin:5px;">Add to Cart</button>';
                }
                echo '</form>                            
